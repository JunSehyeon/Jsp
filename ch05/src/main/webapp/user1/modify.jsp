...
<body>
	...
	<form action="./proc/modify.jsp" method="post">
		<table border="1">
			<tr>
				<td>아이디</td>
				<td><input type="text" name="user_id" readonly value="<%= user1.getUser_id()%>" placeholder="아이디입력"/></td>
			</tr>
			<tr>
				<td>이름</td>
	...
	<% } else { %>
	<p style="color:red;">해당 사용자의 정보를 찾을 수 없습니다. <a href="list.jsp">목록으로 이동</a></p>
<% } %>
</body>
</html>