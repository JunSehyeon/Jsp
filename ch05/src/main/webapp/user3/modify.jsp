...
<%
	...
	if(user_id == null||user_id.trim().equals("")){
		out.println("<h3>잘못된 접근입니다. user_id가 없습니다.</h3>");
		return;
	}
	...
	<body>
		...
		<form action="./proc/modify.jsp" method="post">
			<table border="1">
				<tr>
					<td>아이디</td>
					<td><input type="text" name="user_id" readonly value="<%= user3.getUser_id()%>" placeholder="아이디입력"/></td>		
				</tr>
				<tr>
					<td>이름</td>
				...
				<tr>
					<td>나이</td>
					<td><input type="text" name="age" value="<%= user3.getAge()%>" placeholder="숫자 입력"/></td>		
				</tr>
				<tr>
